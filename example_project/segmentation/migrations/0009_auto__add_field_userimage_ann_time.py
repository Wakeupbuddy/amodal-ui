...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserImage.ann_time'
        db.add_column(u'segmentation_userimage', 'ann_time',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserImage.ann_time'
        db.delete_column(u'segmentation_userimage', 'ann_time')
    ...
    models = {
        ...
        u'segmentation.userimage': {
            ...
            'ann_time': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
