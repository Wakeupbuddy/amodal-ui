...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'segmentation_assignedimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='assigned_images', unique=True, to=orm['auth.User'])),
        ))
        ...
        db.create_table(u'segmentation_userimage', (
            ...
            ('namelist_str', self.gf('django.db.models.fields.TextField')()),
