...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Point.y'
        db.alter_column(u'segmentation_point', 'y', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Point.x'
        db.alter_column(u'segmentation_point', 'x', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Point.y'
        db.alter_column(u'segmentation_point', 'y', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Point.x'
        db.alter_column(u'segmentation_point', 'x', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'segmentation.polygon': {
            'Meta': {'ordering': "['annotation__id']", 'object_name': 'Polygon'},
