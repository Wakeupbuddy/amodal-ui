...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserImage.status_str'
        db.add_column(u'segmentation_userimage', 'status_str',
                      self.gf('django.db.models.fields.TextField')(default='clean'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserImage.status_str'
        db.delete_column(u'segmentation_userimage', 'status_str')
    ...
    models = {
        ...
        u'segmentation.userimage': {
            ...
            'namelist_str': ('django.db.models.fields.TextField', [], {}),
            'polygons_str': ('django.db.models.fields.TextField', [], {}),
            'status_str': ('django.db.models.fields.TextField', [], {'default': "'clean'"}),
