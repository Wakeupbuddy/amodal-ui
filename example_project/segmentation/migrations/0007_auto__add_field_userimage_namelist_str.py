...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserImage.namelist_str'
        db.add_column(u'segmentation_userimage', 'namelist_str',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserImage.namelist_str'
        db.delete_column(u'segmentation_userimage', 'namelist_str')
